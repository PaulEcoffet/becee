...
CREATE TABLE `business_images` (
  ...
  KEY `user_id` (`user_id`),
  KEY `business_id` (`business_id`),
  KEY `business_images_ibfk_3` (`comment_id`),
...
INSERT INTO `business_images` VALUES (1,NULL,1,NULL,255,'upload/images_businesses/home-holder1.png'),(2,NULL,2,NULL,255,'img/default-business-img.png'),(3,NULL,3,NULL,255,'img/default-business-img.png'),(4,NULL,4,NULL,255,'img/default-business-img.png'),(5,NULL,5,NULL,255,'img/default-business-img.png'),(6,NULL,6,NULL,255,'upload/images_businesses/home-holder4.png'),(7,NULL,7,NULL,255,'upload/images_businesses/home-holder2.png'),(8,NULL,8,NULL,255,'upload/images_businesses/home-holder3.png'),(9,NULL,9,NULL,255,'img/default-business-img.png'),(10,NULL,10,NULL,255,'img/default-business-img.png');
...
INSERT INTO `cities` VALUES (1,'Bordeaux',1,1,44.837789,-0.57918,33000),(2,'New York',2,2,40.7143528,-74.0059731,10007),(3,'Paris',3,3,48.856614,2.3522219,75000),(4,'Tokyo',4,4,35.6894875,139.6917064,951);
...
INSERT INTO `link_comments_images` VALUES (1,1);
...
--
-- Table structure for table `vm_score_businesses_features`
--

DROP TABLE IF EXISTS `vm_score_businesses_features`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `vm_score_businesses_features` (
  ...
  CONSTRAINT `vm_score_businesses_features_ibfk_2` FOREIGN KEY (`business_id`) REFERENCES `businesses` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `vm_score_businesses_features`
--

LOCK TABLES `vm_score_businesses_features` WRITE;
/*!40000 ALTER TABLE `vm_score_businesses_features` DISABLE KEYS */;
INSERT INTO `vm_score_businesses_features` VALUES (1,1,1200,3,NULL,NULL,'2014-05-12 14:52:05'),(1,5,1400,2,NULL,NULL,'2014-05-12 14:52:05'),(1,6,1400,4,NULL,NULL,'2014-05-12 14:52:05'),(1,7,1400,4,NULL,NULL,'2014-05-12 14:52:05'),(2,1,1400,2,NULL,NULL,'2014-05-12 14:52:05'),(2,5,1400,1,NULL,NULL,'2014-05-12 14:52:05'),(2,6,1400,3,NULL,NULL,'2014-05-12 14:52:05'),(2,7,1400,3,NULL,NULL,'2014-05-12 14:52:05'),(3,1,100,4,NULL,NULL,'2014-05-12 14:52:05'),(3,6,1400,2,NULL,NULL,'2014-05-12 14:52:05'),(3,7,1400,2,NULL,NULL,'2014-05-12 14:52:05'),(4,1,1400,1,NULL,NULL,'2014-05-12 14:52:05'),(4,6,1400,1,NULL,NULL,'2014-05-12 14:52:05'),(4,7,1400,1,NULL,NULL,'2014-05-12 14:52:05');
...
-- Dump completed on 2014-05-12 15:03:22
